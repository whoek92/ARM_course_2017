...
{
  WM8731_CW(WM8731_PDC,(WM8731_PDC_MICPD + WM8731_PDC_DACPD + WM8731_PDC_OSCPD + WM8731_PDC_CLKOUTPD + WM8731_PDC_ADCPD + WM8731_PDC_POWEROFF)^0xFFFF);
  WM8731_CW(WM8731_AAPC,WM8731_AAPC_INSEL + WM8731_AAPC_MICBOOST + WM8731_AAPC_SIDETONE + WM8731_AAPC_DACSEL);
}
